...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente
    {
        ...
        {
            //converte o objeto passado como parâmetro para object, e caso haja uma falha na 
            //passagem de parâmetro o objeto ficará como null
            ContaCorrente outraConta = obj as ContaCorrente;
            if (outraConta==null)
            {
                return false;
            }
            //retorna Numero e Agencia de acordo com a referência de objeto passada como parâmetro
